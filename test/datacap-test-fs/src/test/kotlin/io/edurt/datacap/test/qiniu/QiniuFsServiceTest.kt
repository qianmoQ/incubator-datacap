...
class QiniuFsServiceTest
{
    ...
    init
    {
        ...
        request = FsRequest.builder()
            .access(System.getProperty("qiniu.access"))
            .secret(System.getProperty("qiniu.secret"))
            .bucket(System.getProperty("qiniu.bucket"))
            .endpoint(System.getProperty("qiniu.endpoint"))
            .localPath(
                listOf(
                    System.getProperty("user.dir"),
                    "src/test/kotlin/io/edurt/datacap/test/qiniu/QiniuFsPluginTest.kt"
    ...
    fun step4_reader()
    {
        ...
        plugin.ifPresent {
            ...
            log.info("QiniuFs reader response [ {} ]", response)
            assertTrue(response.isSuccessful)
