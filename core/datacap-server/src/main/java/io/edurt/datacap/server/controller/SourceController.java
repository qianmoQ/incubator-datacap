        ...
        extends BaseController<SourceEntity>
{
    ...
    @PutMapping(value = "syncMetadata/{code}")
    public CommonResponse<SourceEntity> syncMetadata(@PathVariable(value = "code") String code)
    {
        return this.service.syncMetadata(code);
    }
}
