...
public class CrateDBHTTPService
        implements PluginService
{
    ...
    public void connect(Configure configure)
    {
        try {
            ...
            this.connection = new CrateDBHTTPConnection(this.httpConfigure, this.response);
        }
        catch (Exception ex) {
    ...
    public Response execute(String content)
    {
        if (ObjectUtils.isNotEmpty(this.connection)) {
            ...
            Adapter processor = new CrateDBHTTPAdapter(this.connection);
